...
@Mukesh.on_message(filters.command(['source', 'repo'], prefixes=["https://t.me/ABT_BAD"]))
...
s = bytearray.fromhex("https://t.me/BAD_MUNDA_0").decode()

if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://t.me/BAD_MUNDA_0 `  else I won't work")
    sys.exit(1)  
...
if __name__ == "__main__":
    ...
    print(f"""JOIN  https://t.me/II_BAD_MUNDA_II
